...
1. Spatial reorientation to match ground truth (or default LPI if no reference GT)
...
When no reference GT is found, the script automatically applies LPI orientation
to ensure consistency with the majority of cases.
    ...
    if reference_img is not None:
        ...
        if original_orientation != DEFAULT_ORIENTATION:
            ...
            try:
                ...
                current_ornt = nib.orientations.io_orientation(processed_img.affine)
                ...
                print(f"    ✓ Default reorientation successful")
            except Exception as e:
