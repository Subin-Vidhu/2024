...
path_to_dicom = r"C:/Users/USER/Desktop/Celsus_Mammo/dicom_files/252/252"
path_to_nifti = r"C:/Users/USER/Desktop/Celsus_Mammo/nifti_files"
path_to_editor_files = r"C:/Users/USER/Desktop/Celsus_Mammo/editor_files"
...
subp_result = subprocess.run(["C:/Users/USER/Desktop/Celsus_Mammo/dcm2niix/dcm2niix.exe","-9","-f","%j","-d","9","-z","y","-o", path_to_nifti, path_to_dicom], stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
...
ds = pydicom.dcmread("C:/Users/USER/Desktop/Celsus_Mammo/dicom_files/252/252/0.dcm")
...
if (not os.path.isfile(individual_nifti_path)):
    raise FileNotFoundError("Could not find file",individual_nifti_path)
...
nib.save(img,os.path.join(path_to_editor_files,f"img_CT.nii.gz"))
