   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: sqlalchemy==2.0.22 in /opt/anaconda3/envs/genai4sd/lib/python3.10/site-packages (2.0.22)\n",
      "Requirement already satisfied: typing-extensions>=4.2.0 in /opt/anaconda3/envs/genai4sd/lib/python3.10/site-packages (from sqlalchemy==2.0.22) (4.12.2)\n",
      "Requirement already satisfied: greenlet!=0.4.17 in /opt/anaconda3/envs/genai4sd/lib/python3.10/site-packages (from sqlalchemy==2.0.22) (3.1.1)\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/5q/rtd7dw9157dbsr3lx_m2kvbw0000gp/T/ipykernel_45856/3313856239.py:6: MovedIn20Warning: The ``declarative_base()`` function is now available as sqlalchemy.orm.declarative_base(). (deprecated since: 2.0) (Background on SQLAlchemy 2.0 at: https://sqlalche.me/e/b8d9)\n",
